...
<body>
            ...
            <div style="min-height: 500px;padding-top:7rem;padding-bottom: 7rem;"
                ...
                <div class="row mb-5 w-100 item-bottom justify-content-center">
                    ...
                    <div class="col-md-4 item-bottom col-12 text-center">
                        <h2 class="mb-2 great-vibes fw-bold">Hamal Difa Hardian Surya</h2>
                        <img class="mb-2" src="assets/image/wave-flower.png" alt="">
                        <p>Putra Dari <br>
                ...
                <h5 class="mb-5 mt-5">Minggu, 29 Desember 2024</h5>
                ...
                <div class="row mb-4 w-100 justify-content-center">
                    <div class="col-md-4 col-12">
                        <div
                            ...
                            <p class="mb-3"><i class="fa fa-calendar"></i> Minggu, 29 Desember 2024</p>
                            <p class="mb-3"><i class="fa fa-clock"></i> 11:00 WIB - Selesai</p>
    ...
    <script>
        // Timeout schedule
        // Set target date
        const targetDate = new Date('2024-12-29T11:00:00').getTime();
